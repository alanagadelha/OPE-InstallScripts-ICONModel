...
HH=$1
DATE=`cat /home/opicon/operacional/currentdates/currentdate${HH}`
...
! output_bounds               =          0., 432000., 3600.       ! start, end, increment
 ...
 include_last                =                     .FALSE.
 output_filename             =                    'iconlam_met'
 filename_format             = '<output_filename>_${HH}_${DATE}_<jfile>_<levtype_l>' ! file name base
 output_grid                =                      .TRUE.
...
'prec_con','prec_gsp','rain_con','rain_gsp','snow_con','snow_gsp','tot_prec',
'rh_2m','u_10m','v_10m','sp_10m','gust10','pres_sfc','pres_msl','topography_c',
'tmax_2m','tmin_2m','td_2m','t_2m'
/
