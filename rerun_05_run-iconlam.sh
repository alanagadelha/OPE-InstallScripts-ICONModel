...
if [ $# -ne 2 ]; then
	...
	echo "Entre com o horario da rodada (00/12) e a data (yyyymmdd):"
	echo "Ex.: rerun_05_run-iconlam.sh 00 20220304"
	exit 1
...
HSTART=`date --date="$DATE" +%Y-%m-%dT${HH}:00:00Z`
HSTOP=`date --date="$DATE +5day" +%Y-%m-%dT${HH}:00:00Z`
...
#/home/devicon/instalacao-intel2019.5/libraries/bin/mpiexec -f /home/opicon/operacional/data/const/icon_model_nodes.txt -n 960 $MODEL
#/home/devicon/instalacao-intel2019.5/libraries/bin/mpiexec -f /home/opicon/operacional/data/const/icon_model_nodes.txt -n 768 $MODEL
